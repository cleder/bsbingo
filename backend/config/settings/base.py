...
LOCAL_APPS = [
    "bsbingo.users.apps.UsersConfig",
...
MIGRATION_MODULES = {"sites": "bsbingo.contrib.sites.migrations"}
...
MIDDLEWARE = [
    ...
    "bsbingo.utils.healthcheck.HealthCheckMiddleware",
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "bsbingo.utils.context_processors.settings_context",
            ],
        },
    }
]
...
# https://django-allauth.readthedocs.io/en/latest/account/configuration.html
ACCOUNT_ADAPTER = "bsbingo.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/account/configuration.html
