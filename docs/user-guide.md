...
![Home page with a name entered](images/user-guide/02-home-filled.png)
...
![Share screen](images/user-guide/03-share-screen.png)
...
![Join screen](images/user-guide/04-join.png)
...
![A fresh board](images/user-guide/05-board-fresh.png)

![A board with a few squares marked](images/user-guide/06-board-marked.png)
...
![The winning celebration screen](images/user-guide/07-winner-overlay.png)
...
![The finished board, read-only, with the winning line highlighted](images/user-guide/08-board-won-readonly.png)
...
![Someone else's board after the game ends](images/user-guide/11-join-finished.png)
...
![Dark mode](images/user-guide/09-dark-mode.png)
...
![Mobile home screen](images/user-guide/12-mobile-home.png)

![Mobile board screen](images/user-guide/13-mobile-board.png)
...
- **"Board not found" / "Game not found"** — the link is mistyped or out of
  ...
  ![Not-found page](images/user-guide/10-not-found.png)
...
[`docs/sphinx/`](sphinx/frontend-ux.md).*
