...
- [:microscope: How to monitor the application](#microscope-how-to-monitor-the-application)
  - [How to monitor logs and the deployed application](#how-to-monitor-logs-and-the-deployed-application)
    - [Setup AWS credentials](#setup-aws-credentials)
      - [Install monitoring](#install-monitoring)
      - [Connect to Grafana dashboard](#connect-to-grafana-dashboard)
